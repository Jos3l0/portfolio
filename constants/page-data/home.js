...
export const homePageData = {
  ...
  intro:
    "I am a passionate MERN stack web developer from Argentina, deeply in love with coding and exploring various tech domains.",
  status: [
  ...
  resumelink: "/jose-oliva-resume.pdf"
};
